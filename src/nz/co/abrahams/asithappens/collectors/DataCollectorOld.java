 ...
 * @author  mark
 */
public abstract class DataCollectorOld {
    
    /** Logging provider */
    private static Logger logger = Logger.getLogger(DataCollectorOld.class);
    ...
    /**
     * Creates a new DataCollectorOld.  Must be called by subclass constructors.
     *
     * @param device       the device to poll against
     * @param pollInterval the polling interval
     */
    public DataCollectorOld(Device device, long pollInterval, DataType dataType) {
        this.device = device;
