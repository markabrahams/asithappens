/*
 * IPAccountingActiveCollectorDefinitionDAO.java
 *
 ...
 * @author mark
 */
public class IPAccountingActiveCollectorDefinitionDAO extends CollectorDefinitionDAO implements DataCollectorDAO {
    
    /** Collector creation SQL statement */
    public static final String CREATE = "INSERT INTO IPAccountingActiveCollectors (collectorID) VALUES (?)";
    /** Collector deletion SQL statement */
    public static final String DELETE = "DELETE FROM IPAccountingActiveCollectors WHERE collectorID = ?";
    
    /** Creates a new BandwidthCollector DAO */
    public IPAccountingActiveCollectorDefinitionDAO(Connection connection) {
        super(connection);
    }
    
    /**
     * Creates an IPAccountingActiveCollectorDefinition in the database.
     *
    ...
    public int create(CollectorDefinition collectorDefinition) throws DBException {
        IPAccountingActiveCollectorDefinition definition;
        int collectorID;
        PreparedStatement statement;
        
        definition = (IPAccountingActiveCollectorDefinition)collectorDefinition;
        ...
        try {
            ...
            logger.error("Problem creating IPAccountingActiveCollectorDefinition in database for session " + collectorID);
            throw new DBException("Problem creating IPAccountingActiveCollectorDefinition in database for session " + collectorID, e);
        }
    }
    
    /**
     * Retrieves a IPAccountingActiveCollectorDefinition from the database.
     *
     * @param collectorID    the collector ID of the collector
     * @return               the collector definition created from the database definition
     */
    public IPAccountingActiveCollectorDefinition retrieve(int collectorID) throws DBException, UnknownHostException {
        String title;
        Device device;
        long pollInterval;
        boolean storing;
        ...
        return new IPAccountingActiveCollectorDefinition(title, device, pollInterval, storing);
    }
    
    /**
     * Deletes a IPAccountingActiveCollector definition from the database.
     *
     * @param collectorID      the collector ID of the collector
     */
