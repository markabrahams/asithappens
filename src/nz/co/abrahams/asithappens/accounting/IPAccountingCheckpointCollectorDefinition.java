...
public class IPAccountingCheckpointCollectorDefinition extends CollectorDefinition {
     ...
     */
    public IPAccountingCheckpointCollectorDefinition(String title, Device device,
    ...
    public IPAccountingCheckpointCollector spawnCollector() throws UnknownHostException, SNMPException {
        IPAccountingCheckpointSNMP snmp;
        
        snmp = new IPAccountingCheckpointSNMP(device);
        return new IPAccountingCheckpointCollector(this, snmp);
    }
