/*
 * ResponseWindowsCollectorDAO.java
 *
 ...
 * @author mark
 */
public class ResponseWindowsCollectorDAO implements DataCollectorDAO {
    ...
    /** Logging provider */
    public static Logger logger = Logger.getLogger(ResponseWindowsCollectorDAO.class);
    
    /** Database connection */
    Connection connection;
    
    /** Creates a new ResponseWindowsCollector DAO */
    public ResponseWindowsCollectorDAO(Connection connection) {
    ...
    public void create(int sessionID, DataCollector dataCollector) throws DBException {
        ResponseWindowsCollector collector;
        PreparedStatement statement;
        int deviceID;
        
        collector = (ResponseWindowsCollector)dataCollector;
        try {
    ...
    /**
     * Retrieves a ResponseWindowsCollector defintion from the database.
     *
