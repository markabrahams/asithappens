 ...
 * ColorConstant.java
 *
 * Created on 26 November 2005, 23:46
 *
...
/**
 * Stores constant color objects to be used by the application.
 *
 * @author mark
 */
public class ColorConstant {
    ...
    public static Color antiquewhite = new Color(240,255,255);
    ...
    public static Color caderblue = new Color(95,158,160);
    ...
    public static Color darkslategray = new Color(72,61,139);
    ...
    public static Color gold = new Color(255,215,0);
            ...
            lightgoldenrodyellow  FAFAD2  250,250,210  001  -    002  FFFFCC  255,255,204
    ...
    /** Creates a new instance of ColorConstant. */
