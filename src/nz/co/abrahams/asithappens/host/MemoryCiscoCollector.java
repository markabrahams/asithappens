 ...
 * @author  mark
 */
public class MemoryCiscoCollector extends DataCollector {
     ...
     */
    public MemoryCiscoCollector(MemoryCiscoSNMP snmp, long pollInterval, int memoryIndex) throws SNMPException {
