/*
 * MemoryCiscoCollectorDefinition.java
 *
...
public class MemoryCiscoCollectorDefinition extends CollectorDefinition {
     ...
     */
    public MemoryCiscoCollectorDefinition(String title, Device device,
    ...
    public MemoryCiscoCollector spawnCollector() throws UnknownHostException, SNMPException {
        MemoryCiscoSNMP snmp;
        
        snmp = new MemoryCiscoSNMP(device);
        return new MemoryCiscoCollector(this, snmp);
    }
